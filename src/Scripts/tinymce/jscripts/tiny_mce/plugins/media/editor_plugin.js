(function() {
    ...
    tinymce.create("tinymce.plugins.MediaPlugin", {
        init: function(n, j) {
            ...
            n.onNodeChange.add(function(s, i, t) { i.setActive("media", o(t)) })
        },
        ...
        dataToHtml: function(i, j) { return this.editor.serializer.serialize(this.dataToImg(i, j), { force_absolute: j }) },
        ...
        imgToObject: function(x, n) {
            ...
            function q(i, G) {
                ...
                if (H) {
                    ...
                    tinymce.each(I, function(N, M) { D.params[M] = "" + N })
                }
            }
        ...
        objectToImg: function(y) {
            ...
            if (p) {
                ...
                B = B || p.attr("style");
                u = p.attr("id");
                tinymce.each(d, function(i) { G.attr(i, p.attr(i)) });
