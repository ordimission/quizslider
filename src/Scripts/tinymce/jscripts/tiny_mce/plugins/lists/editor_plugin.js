(function() {
    ...
    function b(s) {
        return p(s, function(t) { return t.previousSibling })
    }

    function i(s) {
        return p(s, function(t) { return t.nextSibling })
    }

    function d(s, u, t) {
        return s.dom.getParent(u, function(v) { return tinymce.inArray(t, v) !== -1 })
    }
    ...
    tinymce.create("tinymce.plugins.Lists", {
        init: function(u, v) {
            ...
            u.addCommand("InsertUnorderedList", function() { this.applyList("UL", "OL") }, this);
            u.addCommand("InsertOrderedList", function() { this.applyList("OL", "UL") }, this);
        ...
        classBasedEach: function(v, u) {
            ...
            e(v, function(x) { w.addClass(x, "_mce_act_on") });
