(function(d) {
    ...
    var b = {
        ...
        map: function(g, h) {
            var i = [];
            b.each(g, function(f) { i.push(h(f)) });
            return i
        },
        grep: function(g, h) {
            var i = [];
        ...
        explode: function(f, g) { return f ? b.map(f.split(g || ","), b.trim) : f },
        _addVer: function(g) {
            var f;
            if (!this.query) {
                return g
...
(function(j) {
    ...
    j.html = j.html || { };
    j.html.Entities = {
        encodeRaw: function(m, l) { return m.replace(l ? k : b, function(n) { return g[n] || n }) }, encodeAllRaw: function(l) { return ("" + l).replace(f, function(m) { return g[m] || m }) },
        ...
        getEncodeFunc: function(l, o) {
            ...
            function m(r, q) {
                return r.replace(q ? k : b, function(s) { return g[s] || o[s] || "&#" + s.charCodeAt(0) + ";" || s })
            }
...
tinymce.html.Styles = function(d, f) {
    ...
    return {
        ...
        parse: function(r) {
            ...
            function i(B, A) {
                if (q) {
                    B = B.replace( /_[0-9]/g , function(C) { return a[C] })
                }
                if (!A) {
                    B = B.replace( /\\([\'\";:])/g , "$1")
                }
            ...
            if (r) {
                r = r.replace( /\\[\"\';:_]/g , s).replace( /\"[^\"]+\"|\'[^\']+\'/g , function(A) { return A.replace( /[;:]/g , s) });
                while (p = b.exec(r)) {
...
(function(l) {
    ...
    function a(q, p) {
        ...
        function m(r) {
            return r.replace( /[A-Z]+/g , function(s) { return m(q[s]) })
        }
    ...
    l.html.Schema = function(p) {
        ...
        if (p.valid_styles) {
            o = { };
            j(p.valid_styles, function(z, y) { o[y] = l.explode(z) })
        }
        ...
        function t(y) {
            ...
            u = [];
            r(y);
            j(g, function(A, z) { n[z] = A.children })
        }
        ...
        if (!p.valid_elements) {
            ...
            j(h("ol,ul,li,sub,sup,blockquote,tr,div,span,font,a,table,tbody"), function(y) { m[y].removeEmpty = true });
            j(h("p,h1,h2,h3,h4,h5,h6,th,td,pre,div,address,caption"), function(y) { m[y].paddEmpty = true })
        } else {
            t(p.valid_elements)
        }
        q(p.custom_elements);
        ...
        x.children = n;
        x.styles = o;
        x.getBoolAttrs = function() { return i };
        x.getBlockElements = function() { return k };
        x.getShortEndedElements = function() { return f };
        x.getSelfClosingElements = function() { return e };
        x.getNonEmptyElements = function() { return d };
        x.getWhiteSpaceElements = function() { return b };
    ...
    b.html.DomParser = function(g, h) {
        ...
        f.parse = function(u, m) {
            ...
            n = new b.html.SaxParser({
                validate: x, fix_self_closing: !x, cdata: function(l) { z.append(G("#cdata", 4)).value = l },
                text: function(K, l) {
                    var J;
                    if (!r[z.name]) {
                        K = K.replace(k, " ");
                ...
                comment: function(l) { z.append(G("#comment", 8)).value = l },
                pi: function(l, J) {
...
(function(a) {
    a.html.Serializer = function(c, d) {
        ...
        b.serialize = function(h) {
            ...
            i = c.validate;
            g = {
                3: function(k, j) { e.text(k.value, k.raw) }, 8: function(j) { e.comment(j.value) }, 7: function(j) { e.pi(j.name, j.value) }, 10: function(j) { e.doctype(j.value) }, 4: function(j) { e.cdata(j.value) },
                11: function(j) {
                    if ((j = j.firstChild)) {
                        do {
                            f(j)
...
(function(h) {
    ...
    h.create("tinymce.dom.DOMUtils", {
        doc: null, root: null, files: null, pixelStyles: /^(top|left|bottom|right|width|height|borderWidth)$/ , props: { "for": "htmlFor", "class": "className", className: "className", checked: "checked", disabled: "disabled", maxlength: "maxLength", readonly: "readOnly", selected: "selected", value: "value", id: "id", name: "name", type: "type" },
        DOMUtils: function(n, l) {
            ...
            if (b) {
                ("abbr article aside audio canvas details figcaption figure footer header hgroup mark menu meter nav output progress section summary time video").replace( /\w+/g , function(o) { n.createElement(o) })
            }
        ...
        getParent: function(l, k, j) { return this.getParents(l, k, j, false) },
        getParents: function(u, p, l, s) {
            ...
            if (e(p, "string")) {
                j = p;
                if (p === "*") {
                    p = function(o) { return o.nodeType == 1 }
                } else {
                    p = function(o) { return k.is(o, j) }
                }
            }
            while (u) {
        ...
        getNext: function(k, j) { return this._findSib(k, j, "nextSibling") },
        getPrev: function(k, j) { return this._findSib(k, j, "previousSibling") },
        select: function(l, k) {
            var j = this;
        ...
        create: function(l, j, k) { return this.add(this.doc.createElement(l), l, j, k, 1) },
        ...
        setStyle: function(m, j, k) {
            ...
            return l.run(m, function(p) {
                var o, n;
                o = p.style;
                j = j.replace( /-(\D)/g , function(r, q) { return q.toUpperCase() });
        ...
        getStyle: function(m, j, l) {
            ...
            if (this.doc.defaultView && l) {
                j = j.replace( /[A-Z]/g , function(n) { return "-" + n });
                try {
            ...
            j = j.replace( /-(\D)/g , function(o, n) { return n.toUpperCase() });
            if (j == "float") {
        ...
        setStyles: function(m, n) {
            ...
            j = l.update_styles;
            l.update_styles = 0;
            f(n, function(o, p) { k.setStyle(m, p, o) });
            l.update_styles = j;
            if (l.update_styles) {
        ...
        setAttrib: function(l, m, j) {
            ...
            return this.run(l, function(o) {
                ...
                case "style":
                    if (!e(j, "string")) {
                        f(j, function(p, q) { k.setStyle(o, q, p) });
                        return
                    }
                    if (n.keep_values) {
                        if (j && !k._isRes(j)) {
        ...
        setAttribs: function(k, l) {
            var j = this;
            return this.run(k, function(m) { f(l, function(o, p) { j.setAttrib(m, p, o) }) })
        },
        ...
        parseStyle: function(j) { return this.styles.parse(j) },
        serializeStyle: function(k, j) { return this.styles.serialize(k, j) },
        loadCSS: function(j) {
        ...
        show: function(j) { return this.setStyle(j, "display", "block") },
        hide: function(j) { return this.setStyle(j, "display", "none") },
        isHidden: function(j) {
            j = this.get(j);
            return !j || j.style.display == "none" || this.getStyle(j, "display") == "none"
        },
        uniqueId: function(j) { return (!j ? "mce_" : j) + (this.counter++) },
        ...
        replace: function(p, m, j) {
            ...
            return l.run(m, function(k) {
                if (j) {
                    f(h.grep(k.childNodes), function(n) { p.appendChild(n) })
                }
        ...
        rename: function(m, j) {
            ...
            if (m.nodeName != j.toUpperCase()) {
                k = l.create(j);
                f(l.getAttribs(m), function(n) { l.setAttrib(k, n.nodeName, l.getAttrib(m, n.nodeName)) });
                l.replace(k, m, 1)
            }
            return k || m
        },
        ...
        getAttribs: function(k) {
            ...
            if (b) {
                ...
                k.cloneNode(false).outerHTML.replace( /<\/?[\w:\-]+ ?|=[\"][^\"]+\"|=\'[^\']+\'|=[\w\-]+|>/gi , "").replace( /[\w:\-]+/gi , function(l) { j.push({ specified: 1, nodeName: l }) });
                return j
            }
            return k.attributes
        },
        ...
        _isRes: function(j) { return /^(top|left|bottom|right|width|height)/i .test(j) || /;\s*(top|left|bottom|right|width|height)/i .test(j) }
    });
...
(function() {
    ...
    function a(g) {
        ...
        this.destroy = function() { h = e = null }
    }
...
(function() {
    ...
    b.error = function(e) { throw "Syntax error, unrecognized expression: " + e };
    var f = b.selectors = {
        order: ["ID", "NAME", "TAG"], match: { ID: /#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/ , CLASS: /\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/ , NAME: /\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/ , ATTR: /\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/ , TAG: /^((?:[\w\u00c0-\uFFFF\*\-]|\\.)+)/ , CHILD: /:(only|nth|last|first)-child(?:\((even|odd|[\dn+\-]*)\))?/ , POS: /:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^\-]|$)/ , PSEUDO: /:((?:[\w\u00c0-\uFFFF\-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/ }, leftMatch: { }, attrMap: { "class": "className", "for": "htmlFor" }, attrHandle: { href: function(e) { return e.getAttribute("href") } },
        relative: {
            "+": function(x, r) {
        ...
        find: {
            ...
            TAG: function(e, r) { return r.getElementsByTagName(e[1]) }
        },
        preFilter: {
            ...
            TAG: function(r, e) { return r[1].toLowerCase() },
            CHILD: function(e) {
                if (e[1] === "nth") {
        ...
        filters: {
            enabled: function(e) { return e.disabled === false && e.type !== "hidden" }, disabled: function(e) { return e.disabled === true }, checked: function(e) { return e.checked === true },
            selected: function(e) {
            ...
            has: function(s, r, e) { return !!b(e[3], s).length },
        ...
        setFilters: { first: function(r, e) { return e === 0 }, last: function(s, r, e, t) { return r === t.length - 1 }, even: function(r, e) { return e % 2 === 0 }, odd: function(r, e) { return e % 2 === 1 }, lt: function(s, r, e) { return r < e[3] - 0 }, gt: function(s, r, e) { return r > e[3] - 0 }, nth: function(s, r, e) { return e[3] - 0 === r }, eq: function(s, r, e) { return e[3] - 0 === r } },
        filter: {
            ...
            ID: function(r, e) { return r.nodeType === 1 && r.getAttribute("id") === e },
            TAG: function(r, e) { return (e === "*" && r.nodeType === 1) || r.nodeName.toLowerCase() === e },
            CLASS: function(r, e) { return (" " + (r.className || r.getAttribute("class")) + " ").indexOf(e) > -1 },
            ATTR: function(v, t) {
    ...
    var k = f.match.POS, g = function(r, e) { return "\\" + (e - 0 + 1) };
    ...
    (function() {
        ...
        if (e.firstChild && typeof e.firstChild.getAttribute !== "undefined" && e.firstChild.getAttribute("href") !== "#") {
            f.attrHandle.href = function(r) { return r.getAttribute("href", 2) }
        }
        e = null
    })();
    ...
    b.contains = document.compareDocumentPosition ? function(r, e) { return !!(r.compareDocumentPosition(e) & 16) } : function(r, e) { return r !== e && (r.contains ? r.contains(e) : true) };
    b.isXML = function(e) {
...
(function(a) {
    a.dom.Element = function(f, d) {
        ...
        a.extend(b, {
            on: function(i, h, g) { return a.dom.Event.add(b.id, i, h, g) }, getXY: function() { return { x: parseInt(b.getStyle("left")), y: parseInt(b.getStyle("top")) } },
            getSize: function() {
                var g = e.get(b.id);
...
(function(a) {
    a.dom.Serializer = function(e, i, f) {
        ...
        return {
            schema: f, addNodeFilter: c.addNodeFilter, addAttributeFilter: c.addAttributeFilter, onPreProcess: h, onPostProcess: b,
...
(function(b) {
    ...
    b.create("tinymce.ui.KeyboardNavigation", {
        KeyboardNavigation: function(e, f) {
            ...
            f = f || b.DOM;
            j = function(q) { g = q.target.id };
            h = function(q) { f.setAttrib(q.target.id, "tabindex", "-1") };
            d = function(q) {
                var r = f.get(g);
                f.setAttrib(r, "tabindex", "0");
                r.focus()
            };
            p.focus = function() { f.get(g).focus() };
            p.destroy = function() {
                c(l, function(q) {
...
(function(d) {
    ...
    d.create("tinymce.ui.ListBox:tinymce.ui.Control", {
        ...
        renderMenu: function() {
            ...
            f.add({
                title: g.settings.title, "class": "mceMenuItemTitle",
                onclick: function() {
            ...
            e(g.items, function(h) {
                if (h.value === undefined) {
                    f.add({
                        title: h.title, "class": "mceMenuItemTitle",
                        onclick: function() {
                            if (g.settings.onselect("") !== false) {
                                g.select("")
                            }
    ...
    d.create("tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton", {
        ...
        renderMenu: function() {
            ...
            new d.ui.KeyboardNavigation({
                root: p.id + "_menu", items: c.select("a", p.id + "_menu"),
                onCancel: function() {
                    p.hideMenu();
                    p.focus()
                }
...
(function(b) {
    ...
    b.create("tinymce.ui.ToolbarGroup:tinymce.ui.Container", {
        ...
        postRender: function() {
            ...
            f.keyNav = new b.ui.KeyboardNavigation({ root: f.id, items: e, onCancel: function() { f.editor.focus() }, excludeFromTabOrder: !f.settings.tab_focus_toolbar })
        },
        destroy: function() {
            var e = this;
            e.parent();
...
(function(j) {
    ...
    j.EditorManager = d(j, {
        editors: [], i18n: { }, activeEditor: null,
        init: function(q) {
...
(function(m) {
    ...
    m.create("tinymce.Editor", {
        ...
        init: function() {
            ...
            if (G.content_css) {
                m.each(g(G.content_css), function(s) { F.contentCSS.push(F.documentBaseURI.toAbsolute(s)) })
            }
        ...
        setupIframe: function() {
            ...
            i("p h1 h2 h3 h4 h5 h6 div address pre div code dt dd samp".split( /\s/ ), function(s) { r.formatter.register(s, { block: s, remove: "all" }) });
            ...
            r.undoManager.onUndo.add(function(t, s) { return r.onUndo.dispatch(r, s, t) });
            r.undoManager.onRedo.add(function(t, s) { return r.onRedo.dispatch(r, s, t) });
            r.forceBlocks = new m.ForceBlocks(r, { forced_root_block: x.forced_root_block });
            r.editorCommands = new m.EditorCommands(r);
            r.serializer.onPreProcess.add(function(s, t) { return r.onPreProcess.dispatch(r, t, s) });
            r.serializer.onPostProcess.add(function(s, t) { return r.onPostProcess.dispatch(r, t, s) });
            ...
            if (x.handle_node_change_callback) {
                r.onNodeChange.add(function(t, s, A) { r.execCallback("handle_node_change_callback", r.id, A, -1, -1, true, r.selection.isCollapsed()) })
            }
            if (x.save_callback) {
            ...
            if (x.onchange_callback) {
                r.onChange.add(function(t, s) { r.execCallback("onchange_callback", r, s) })
            }
            if (x.protect) {
                r.onBeforeSetContent.add(function(s, t) {
                    if (x.protect) {
                        i(x.protect, function(A) { t.content = t.content.replace(A, function(B) { return "<!--mce:protected " + escape(B) + "-->" }) })
                    }
                })
            }
            ...
            if (x.cleanup_callback) {
                r.onBeforeSetContent.add(function(s, t) { t.content = r.execCallback("cleanup_callback", "insert_to_editor", t.content, t) });
            ...
            r.onSetContent.add(function() { r.addVisual(r.getBody()) });
        ...
        addCommand: function(p, r, q) { this.execCommands[p] = { func: r, scope: q || this } },
        addQueryStateHandler: function(p, r, q) { this.queryStateCommands[p] = { func: r, scope: q || this } },
        addQueryValueHandler: function(p, r, q) { this.queryValueCommands[p] = { func: r, scope: q || this } },
        ...
        _addEvents: function() {
            ...
            i(x, function(t, s) {
                ...
                case "contextmenu":
                    ...
                    break;
                case "paste":
                    q.bind(B.getBody(), s, function(D) { p(D) });
                    break;
                case "submit":
                case "reset":
            ...
            q.bind(C.content_editable ? B.getBody() : (a ? B.getDoc() : B.getWin()), "focus", function(s) { B.focus(true) });
            if (m.isGecko) {
            ...
            if (m.isOpera) {
                B.onClick.add(function(s, t) { j.prevent(t) })
            }
            if (C.custom_undo_redo) {
                ...
                B.dom.bind(B.dom.getRoot(), "dragend", function(s) { y() });
            ...
            if (m.isGecko) {
                ...
                function A() {
                    ...
                    return function() {
                        ...
                        i(s, function(D) { t.setAttributeNode(D.cloneNode(true)) })
                    }
                }
...
(function(c) {
    ...
    c.EditorCommands = function(n) {
        ...
        t({
            ...
            "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": function(u) { r(u) },
            ...
            FormatBlock: function(x, v, u) { return r(u || "p") },
            mceCleanup: function() {
                var u = p.getBookmark();
            ...
            mceInsertRawHTML: function(x, v, u) {
                ...
                n.setContent(n.getContent().replace( /tiny_mce_marker/g , function() { return u }))
            },
            ...
            mceReplaceContent: function(x, v, u) { n.execCommand("mceInsertContent", false, u.replace( /\{\$selection\}/g , p.getContent({ format: "text" }))) },
            mceInsertLink: function(A, z, y) {
                ...
                if (!x) {
                    ...
                    d(l.select("a[href='javascript:mctmp(0);']"), function(B) { l.setAttribs(B, y) })
                } else {
                    if (y.href) {
                        l.setAttribs(x, y)
                    } else {
        ...
        t({
            "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function(u) { return s("align" + u.substring(7)) }, "Bold,Italic,Underline,Strikethrough,Superscript,Subscript": function(u) { return s(u) }, mceBlockQuote: function() { return s("blockquote") },
            Outdent: function() {
                var u;
                if (k.inline_styles) {
...
(function(b) {
    ...
    b.UndoManager = function(e) {
        ...
        return c = {
            typing: false, onAdd: new a(c), onUndo: new a(c), onRedo: new a(c),
            ...
            hasUndo: function() { return d > 0 || this.typing },
            hasRedo: function() { return d < g.length - 1 && !this.typing }
        }
    }
})(tinymce);
(function(l) {
        ...
        setup: function() {
            ...
            if (p.force_p_newlines) {
                if (!c) {
                    ...
                    l.addUnload(function() { n._previousFormats = 0 });
                    m.onKeyPress.add(function(s, t) {
    ...
    a.Formatter = function(V) {
        ...
        function T(Y, af, aa) {
            ...
            function W(ak, aj) {
                aj = aj || ag;
                if (ak) {
                    O(aj.styles, function(am, al) { c.setStyle(ak, al, r(am, af)) });
                    O(aj.attributes, function(am, al) { c.setAttrib(ak, al, r(am, af)) });
        ...
        function j(Y, ab, aa) {
            ...
            function W(ac) {
                ac = c.getParent(ac, function(ad) { return !!x(ad, Y, ab, true) });
                return x(ac, Y, ab)
            }
        ...
        function r(W, X) {
            if (typeof(W) != "string") {
                ...
                if (X) {
                    W = W.replace( /%(\w+)/g , function(Z, Y) { return X[Y] || Z })
                }
            }
            return W
        }
        ...
        function u(aa, Z) {
            ...
            if (aa && Z) {
                ...
                if (ac(aa, Z)) {
                    ...
                    c.remove(Z);
                    O(a.grep(Z.childNodes), function(ad) { aa.appendChild(ad) });
                    return aa
                }
            }
            return Z
        ...
        function Q(ab, X, aa) {
            ...
            function ae(af) {
                ...
                O(P.remove.reverse(), function(ag) { A(ag.name, ag.vars, af) });
                c.remove(af, 1);
                Z()
            }
